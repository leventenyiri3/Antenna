...
Optimalizálás előtt a VSWR 4.45dB volt, utána 1.14, tehát jelentősen javult a geometriának az enyhe módosításával, anélkül, hogy a nyereséget negatívan befolyásolta volna.
...
A következő ábrákon a feszültség függvényében látható az SWR, a nyereség, front-to-back és front-to-rear ratio, valamint az impedancia.

A ábrán látható az iránykarakterisztika.
Az ábrákon pedig az antenna 3D modellje, az egyes szegmenseken folyó áramok nagysága és fázisa, valamint a távoltér 3D reprezentációja látható.
\begin{figure}[ht]
     \centering
     \begin{subfigure}[b]{0.48\textwidth}
         \centering
