...
A következő ábrákon a feszültség függvényében látható az SWR (\ref{fig:SWR}. ábra), a nyereség, front-to-back és front-to-rear ratio (\ref{fig:GAIN}. ábra), valamint az impedancia (\ref{fig:IMP}.ábra) .
